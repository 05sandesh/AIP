...
# network connection performance and maximum data transfer speed between two devices
# Downloads\iperf-3.1.3-win64>iperf3.exe -c localhost -w 130k 
# throughput is transfer column values - actual data sent
# Bandwidth is bandwidth column - theoritical max data transfer  